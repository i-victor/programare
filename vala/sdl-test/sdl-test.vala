...
// valac --pkg sdl --pkg sdl-gfx -X -lSDL_gfx -o sdl-test sdl-test.vala

// OR, You might need to pass the include directory to the C compiler for it to find header files:
// valac --pkg sdl --pkg sdl-gfx -X -lSDL_gfx -o sdl-test sdl-test.vala --Xcc=-I/usr/include/SDL
