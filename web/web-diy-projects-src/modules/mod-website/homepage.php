...
// Route: ?/page/website.homepage (?page=website.homepage)
	...
	public function Run() {
		...
		$this->PageViewSetVars([
			...
			'main' 		=> SmartMarkersTemplating::render_file_template(
				$this->ControllerGetParam('module-view-path').$this->ControllerGetParam('action').'.mtpl.htm', // is loading the view: views/homepage.mtpl.htm
				[
