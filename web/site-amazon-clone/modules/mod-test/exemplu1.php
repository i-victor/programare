	...
	if($dtime) {
		...
		$this->PageViewSetVars([
			'main' => SmartTemplating::render_file_template(
				$this->ControllerGetParam('module-view-path').'exemplu1-partea2.mtpl.htm',
				[
		...
		//--
		$main = SmartTemplating::render_file_template(
			$this->ControllerGetParam('module-view-path').'exemplu1-partea1.mtpl.htm',
			[
				'YEARS' => '1900:2021'
			]
		);
