...
// Controller: amazon/Electronics
// Route: ?page=amazon.electronics
	...
	public function Run() {
		...
		$tabel_html = (string) SmartTemplating::render_file_template(
			...
			[
				...
				'RESULTS' => 'Products list: Electronics',
		...
		$html = SmartTemplating::render_file_template(
			$this->ControllerGetParam('module-view-path').'electronics.mtpl.htm',
			[
