/*!
 * jQuery Smart Cart v3.0.1, modified by unixman
...
;(function ($, window, document, undefined) {
	...
	var defaults = {
		saveData: null, // null or function(cartJsonData) {} // save
	...
	$.extend(SmartCart.prototype, {
		...
		_setElements: function () {
			...
			this.cart_element.addClass('card bg-light mb-3 sc-cart sc-theme-' + this.options.theme);
		...
		_saveCart: function() {
			var mi = this;
			if(typeof mi.options.saveData == 'function') {
				mi.options.saveData(JSON.stringify(this.cart));
			}
		},
		/*
		...
		// PUBLIC FUNCTIONS
		/*
		 * Public function export cart to JSON
		 */
		exportJson: function() {
			return this._exportJson();
		},
		/*
		 * Public function to add to cart
		 */
		add: function(p) {
			this._addToCart(p);
		},
