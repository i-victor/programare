...
// Controller: amazon/Books
// Route: ?page=amazon.books
...
class SmartAppIndexController extends SmartAbstractAppController {
	...
	public function Run() {
		...
		$tabel_arr = (array) $db->filterDataBooks($limit, $ofs * $limit);
		$total_records = (int) $db->countDataByClass('books');
		...
		$html = SmartTemplating::render_file_template(
			$this->ControllerGetParam('module-view-path').'books.mtpl.htm',
			[
