...
// Controller: amazon/Music
// Route: ?page=amazon.music
...
class SmartAppIndexController extends SmartAbstractAppController {
	...
	public function Run() {
		...
		$tabel_arr = (array) $db->filterDataMusic($limit, $ofs * $limit);
		$total_records = (int) $db->countDataByClass('music');
